...
"}")
        ...
        self.rangefinderValueLabel.setGeometry(QRect(108, 93, 38, 16))
        self.rangefinderValueLabel.setFont(font1)
        ...
        self.rangefinderLabel.setGeometry(QRect(5, 93, 91, 16))
        self.rangefinderLabel.setFont(font1)
